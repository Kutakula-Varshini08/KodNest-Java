...
public class LearningProcess {
    ...
    public static void main(String[] args) {
        ...
        int totalTopics = 20;
        int dailyPracticeHours = 3;
        int learningDays = 5;
        int remainingTopics = totalTopics - completedTopics;
        int weeklyLearningHours = learningDays * dailyPracticeHours;
        double processPercentage = (double) completedTopics * 100 / totalTopics;
        ...
        System.out.println("Progress Percentage:" + processPercentage);
    }
}
